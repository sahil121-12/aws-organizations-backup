...
#     # Create a list to store the enabled services with 1:1 mapping
#     data = []
...
#     # Extract the enabled services from the response
#     enabled_services = [service['ServicePrincipal'] for service in list_services_output['EnabledServicePrincipals']]
